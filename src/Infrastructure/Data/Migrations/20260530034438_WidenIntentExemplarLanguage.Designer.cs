...
namespace FinFlow.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260530034438_WidenIntentExemplarLanguage")]
    partial class WidenIntentExemplarLanguage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinFlow.Application.Chat.Cascade.ChatIntentExemplar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ExemplarText")
                        .IsRequired()
                        .HasMaxLength(500)
                    ...
                    b.Property<string>("IntentMode")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<string>("IntentTask")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasIndex("IsActive", "EmbeddingModel");

                    b.ToTable("chat_intent_exemplars", (string)null);
                });
            ...
            modelBuilder.Entity("FinFlow.Domain.Employees.EmployeeReimbursementProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<byte[]>("BankAccountNumberEncrypted")
                        .HasColumnType("bytea")
                    ...
                    b.Property<string>("ReimbursementEmail")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("reimbursement_email");
                    ...
                    b.ToTable("employee_reimbursement_profile", (string)null);
                });
            ...
            modelBuilder.Entity("FinFlow.Domain.Entities.Budget", b =>
                {
                    ...
                    b.Property<decimal?>("CarryOverFromPreviousMonth")
                        .HasPrecision(15, 2)
                        .HasColumnType("numeric(15,2)")
                    ...
                    b.HasIndex("IdTenant", "Year", "Month", "IsActive")
            ...
            modelBuilder.Entity("FinFlow.Domain.Entities.TenantSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("DefaultCarryOverPercent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric")
                        .HasDefaultValue(0m)
                        .HasColumnName("default_carry_over_percent");
                    ...
                    b.Property<string>("DefaultEnforcementMode")
                        ...
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("SoftBlock")
                        .HasColumnName("default_enforcement_mode");
                    ...
                    b.Property<string>("EscalationApproverRole")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("TenantAdmin")
                        .HasColumnName("escalation_approver_role");

                    b.Property<decimal>("EscalationThreshold")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric")
                        .HasDefaultValue(999999999m)
                        .HasColumnName("escalation_threshold");
                    ...
                    b.Property<bool>("IsEscalationEnabled")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_escalation_enabled");
                    ...
                    b.Property<int>("MaxApprovalAgeHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(72)
                        .HasColumnName("max_approval_age_hours");

                    b.Property<decimal>("MaxClaimAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric")
                        .HasDefaultValue(0m)
                        .HasColumnName("max_claim_amount");
                    ...
                    b.Property<decimal>("ReceiptRequiredAbove")
                        ...
                        .HasColumnType("numeric")
                        .HasDefaultValue(0m)
                        .HasColumnName("receipt_required_above");

                    b.Property<bool>("RequireDifferentApprover")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("require_different_approver");
                    ...
                    b.Property<decimal>("WarningThreshold1")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric")
                        .HasDefaultValue(85m)
                        .HasColumnName("warning_threshold_1");

                    b.Property<decimal>("WarningThreshold2")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("numeric")
                        .HasDefaultValue(95m)
                        .HasColumnName("warning_threshold_2");
            ...
            modelBuilder.Entity("FinFlow.Domain.Entities.TenantSettings", b =>
                {
                    b.HasOne("FinFlow.Domain.Entities.Tenant", null)
                        .WithOne()
                        .HasForeignKey("FinFlow.Domain.Entities.TenantSettings", "IdTenant")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
